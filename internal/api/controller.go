...
func IndexHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.HTML(http.StatusOK, "index.html", gin.H{"weathers": views})
	}
}

func CheckCitiesHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func RegistersHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		var weathers []models.Weather
...
func AlertsHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.HTML(http.StatusOK, "alerts.html", gin.H{"alerts": views})
	}
}

func NewCityGetHandler() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.HTML(http.StatusOK, "new-city.html", gin.H{})
	}
}

func NewCityPostHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(http.StatusOK, gin.H{"name": form.Name})
	}
}
...
func WeatherHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		// With query parameter  https://gin-go
...
func FetchHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		cfg := config.LoadConfig()
		weather.FetchAndStoreWeatherData(db, cfg)
